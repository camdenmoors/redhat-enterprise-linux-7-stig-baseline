...
control "SV-204477" do
  ...
  desc "default", "The executable search path (typically the PATH environment variable)
...
Officer (ISSO)."
  desc "check", "Verify that all local interactive user initialization files' executable search path statements do not contain statements that will reference a working directory other than the user's home directory.

...
The system call rules are loaded into a matching engine that intercepts each syscall made by all programs on the system. Therefore, it is very important to use syscall rules only when absolutely necessary since these affect performance. The more rules, the bigger the performance hit. The performance can be helped, however, by combining syscalls into one rule whenever possible."
  desc "default", "If the system is not configured to audit certain activities and write
...
compromises and damages incurred during a system compromise."
  desc "check", "Verify the operating system generates audit records upon successful/unsuccessful attempts to use the \"unlink\", \"unlinkat\", \"rename\", \"renameat\", and \"rmdir\" syscalls.
...
The audit daemon must be restarted for the changes to take effect."
  ...
  tag satisfies: ["SRG-OS-000466-GPOS-00210", "SRG-OS-000467-GPOS-00210", "SRG-OS-000468-GPOS-00212", "SRG-OS-000392-GPOS-00172", "SRG-OS-000467-GPOS-00211"]
  tag gid: "V-204572"

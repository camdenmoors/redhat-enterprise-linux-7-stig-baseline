...
control "SV-204501" do
  ...
  desc "default", "Malicious users with removable boot media can gain access to a system
...
the Information System Security Officer (ISSO)."
  desc "check", "Verify the system is not configured to use a boot loader on removable media.

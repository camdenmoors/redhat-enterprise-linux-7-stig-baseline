...
control "SV-204416" do
  ...
  desc "default", "Passwords need to be protected at all times, and encryption is the
...
plain text."
  desc "check", "Verify the system's shadow file is configured to store only encrypted representations of passwords. The strength of encryption that must be used to hash passwords for all accounts is SHA512.

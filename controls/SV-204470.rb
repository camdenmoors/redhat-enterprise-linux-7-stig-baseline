...
control "SV-204470" do
  ...
  desc "default", "If the Group Identifier (GID) of a local interactive user's home
...
may not be able to access files that they legitimately should."
  desc "check", "Verify the assigned home directory of all local interactive users is group-owned by that user's primary GID.

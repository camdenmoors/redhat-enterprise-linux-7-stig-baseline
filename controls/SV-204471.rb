...
control "SV-204471" do
  ...
  desc "default", "If local interactive users do not own the files in their directories,
...
owned by the user, this could be an indication of system compromise."
  desc "check", "Verify all files and directories in a local interactive user's home directory have a valid owner.
